    ...
    <html lang="en" dir="ltr">
      ...
      <body className="grid-bg">
        ...
        <script
          ...
          // biome-ignore lint/security/noDangerouslySetInnerHtml: Static trusted Organization JSON-LD for SEO -- no user input, computed at module level from constants
