"""Study in Australia Government Portal source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Australia Government Portal government config."""

    name: str = "Study in Australia Government Portal"
    url: str = "https://www.studyaustralia.gov.au/en/study-information/scholarships"
    source_id: str = "study_in_australia_government_portal"
