"""KAIST International Student Scholarship source configuration."""
...
class Config(BaseFoundationConfig):
    """KAIST International Student Scholarship foundation config."""

    name: str = "KAIST International Student Scholarship"
    url: str = "https://admission.kaist.ac.kr/intl-graduate/"
    source_id: str = "kaist_international_student_scholarship"
