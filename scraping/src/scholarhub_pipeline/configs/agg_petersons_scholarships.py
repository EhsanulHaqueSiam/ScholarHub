"""Peterson's Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """Peterson's Scholarships aggregator config."""

    name: str = "Peterson's Scholarships"
    url: str = "https://www.petersons.com/scholarship-search"
    source_id: str = "petersons_scholarships"
