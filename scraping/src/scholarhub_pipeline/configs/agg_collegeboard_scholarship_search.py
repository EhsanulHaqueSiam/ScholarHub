"""CollegeBoard Scholarship Search source configuration."""
...
class Config(BaseAggregatorConfig):
    """CollegeBoard Scholarship Search aggregator config."""

    name: str = "CollegeBoard Scholarship Search"
    url: str = "https://bigfuture.collegeboard.org/scholarships"
    source_id: str = "collegeboard_scholarship_search"
