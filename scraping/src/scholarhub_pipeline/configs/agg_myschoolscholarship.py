"""MySchoolScholarship source configuration."""
...
class Config(BaseAggregatorConfig):
    """MySchoolScholarship aggregator config."""

    name: str = "MySchoolScholarship"
    url: str = "https://myschoolscholarship.com"
    source_id: str = "myschoolscholarship"
