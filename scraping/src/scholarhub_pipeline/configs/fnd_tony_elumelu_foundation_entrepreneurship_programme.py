"""Tony Elumelu Foundation Entrepreneurship Programme source configuration."""
...
class Config(BaseFoundationConfig):
    """Tony Elumelu Foundation Entrepreneurship Programme foundation config."""

    name: str = "Tony Elumelu Foundation Entrepreneurship Programme"
    url: str = "https://www.tonyelumelufoundation.org/programme"
    source_id: str = "tony_elumelu_foundation_entrepreneurship_programme"
