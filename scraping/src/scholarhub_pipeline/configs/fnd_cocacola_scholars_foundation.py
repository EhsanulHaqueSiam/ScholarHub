"""Coca-Cola Scholars Foundation source configuration."""
...
class Config(BaseFoundationConfig):
    """Coca-Cola Scholars Foundation foundation config."""

    name: str = "Coca-Cola Scholars Foundation"
    url: str = "https://www.coca-colascholarsfoundation.org"
    source_id: str = "cocacola_scholars_foundation"
