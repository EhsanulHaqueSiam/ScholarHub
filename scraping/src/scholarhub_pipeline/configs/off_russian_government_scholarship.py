"""Russian Government Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """Russian Government Scholarship official program config."""

    name: str = "Russian Government Scholarship"
    url: str = "https://education-in-russia.com"
    source_id: str = "russian_government_scholarship"
