"""New Zealand Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """New Zealand Scholarships official program config."""

    name: str = "New Zealand Scholarships"
    url: str = "https://www.mfat.govt.nz/en/aid-and-development/new-zealand-government-scholarships/"
    source_id: str = "new_zealand_scholarships"
