"""EPFL Excellence Fellowships source configuration."""
...
class Config(BaseOfficialConfig):
    """EPFL Excellence Fellowships official program config."""

    name: str = "EPFL Excellence Fellowships"
    url: str = "https://www.epfl.ch/education/studies/en/financing-your-studies/scholarships-and-loans/"
    source_id: str = "epfl_excellence_fellowships"
