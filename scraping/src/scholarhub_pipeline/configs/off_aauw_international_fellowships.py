"""AAUW International Fellowships source configuration."""
...
class Config(BaseOfficialConfig):
    """AAUW International Fellowships official program config."""

    name: str = "AAUW International Fellowships"
    url: str = "https://www.aauw.org/resources/programs/fellowships-grants/current-opportunities/international/"
    source_id: str = "aauw_international_fellowships"
