"""Study in Czech Republic Portal source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Czech Republic Portal government config."""

    name: str = "Study in Czech Republic Portal"
    url: str = "https://www.studyin.cz/financial-support/"
    source_id: str = "study_in_czech_republic_portal"
