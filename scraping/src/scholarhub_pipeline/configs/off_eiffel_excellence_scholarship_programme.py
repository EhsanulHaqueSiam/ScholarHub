"""Eiffel Excellence Scholarship Programme source configuration."""
...
class Config(BaseOfficialConfig):
    """Eiffel Excellence Scholarship Programme official program config."""

    name: str = "Eiffel Excellence Scholarship Programme"
    url: str = "https://www.campusfrance.org/en/eiffel-scholarship-program-of-excellence"
    source_id: str = "eiffel_excellence_scholarship_programme"
