"""Canon Collins Trust Scholarships source configuration."""
...
class Config(BaseFoundationConfig):
    """Canon Collins Trust Scholarships foundation config."""

    name: str = "Canon Collins Trust Scholarships"
    url: str = "https://canoncollins.org.uk/scholarships/"
    source_id: str = "canon_collins_trust_scholarships"
