"""Study in Poland Portal source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Poland Portal government config."""

    name: str = "Study in Poland Portal"
    url: str = "https://study.gov.pl/scholarships"
    source_id: str = "study_in_poland_portal"
