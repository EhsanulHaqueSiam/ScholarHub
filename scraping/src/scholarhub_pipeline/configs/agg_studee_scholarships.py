"""Studee Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """Studee Scholarships aggregator config."""

    name: str = "Studee Scholarships"
    url: str = "https://studee.com/scholarships"
    source_id: str = "studee_scholarships"
