"""FindAMasters source configuration."""
...
class Config(BaseAggregatorConfig):
    """FindAMasters aggregator config."""

    name: str = "FindAMasters"
    url: str = "https://www.findamasters.com/funding"
    source_id: str = "findamasters"
