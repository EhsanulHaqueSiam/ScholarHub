"""Jack Kent Cooke Foundation source configuration."""
...
class Config(BaseFoundationConfig):
    """Jack Kent Cooke Foundation foundation config."""

    name: str = "Jack Kent Cooke Foundation"
    url: str = "https://www.jkcf.org/our-scholarships/"
    source_id: str = "jack_kent_cooke_foundation"
