"""Study in Belgium (Flanders) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Belgium (Flanders) government config."""

    name: str = "Study in Belgium (Flanders)"
    url: str = "https://www.studyinflanders.be/scholarships"
    source_id: str = "study_in_belgium_flanders"
