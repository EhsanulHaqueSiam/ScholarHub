"""Ford Foundation International Fellowships source configuration."""
...
class Config(BaseFoundationConfig):
    """Ford Foundation International Fellowships foundation config."""

    name: str = "Ford Foundation International Fellowships"
    url: str = "https://www.fordfoundation.org/work/challenging-inequality/international-fellowships-program/"
    source_id: str = "ford_foundation_international_fellowships"
