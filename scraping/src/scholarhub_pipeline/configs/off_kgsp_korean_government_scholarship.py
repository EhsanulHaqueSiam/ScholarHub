"""KGSP Korean Government Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """KGSP Korean Government Scholarship official program config."""

    name: str = "KGSP Korean Government Scholarship"
    url: str = "https://www.studyinkorea.go.kr/en/sub/gks/allnew_invite.do"
    source_id: str = "kgsp_korean_government_scholarship"
