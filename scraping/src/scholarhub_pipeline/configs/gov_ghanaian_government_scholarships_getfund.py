"""Ghanaian Government Scholarships (GETFUND) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Ghanaian Government Scholarships (GETFUND) government config."""

    name: str = "Ghanaian Government Scholarships (GETFUND)"
    url: str = "https://www.getfund.gov.gh"
    source_id: str = "ghanaian_government_scholarships_getfund"
