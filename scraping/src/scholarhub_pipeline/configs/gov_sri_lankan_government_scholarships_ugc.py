"""Sri Lankan Government Scholarships (UGC) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Sri Lankan Government Scholarships (UGC) government config."""

    name: str = "Sri Lankan Government Scholarships (UGC)"
    url: str = "https://www.ugc.ac.lk/en/policy-planning/scholarships.html"
    source_id: str = "sri_lankan_government_scholarships_ugc"
