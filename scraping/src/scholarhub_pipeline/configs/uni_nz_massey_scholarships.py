"""Massey University Scholarships source configuration.

Targets the Massey University scholarships and awards page. Multi-record
listing with JS-based filtering system requiring scrapling for dynamic
content rendering. Embedded JSON configuration drives filter categories.
...
class Config(BaseOfficialConfig):
    """Massey University Scholarships config."""

    name: str = "Massey University Scholarships"
    url: str = "https://www.massey.ac.nz/study/scholarships-and-awards/"
    source_id: str = "nz_massey_scholarships"
