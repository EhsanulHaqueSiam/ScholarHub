"""BADEA Scholarship (Arab Bank for Economic Development) source configuration."""
...
class Config(BaseOfficialConfig):
    """BADEA Scholarship (Arab Bank for Economic Development) official program config."""

    name: str = "BADEA Scholarship (Arab Bank for Economic Development)"
    url: str = "https://www.badea.org/page/scholarships"
    source_id: str = "badea_scholarship_arab_bank_for_economic_development"
