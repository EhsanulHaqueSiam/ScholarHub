"""AfDB Japan Africa Dream Scholarship (JADS) source configuration."""
...
class Config(BaseOfficialConfig):
    """AfDB Japan Africa Dream Scholarship (JADS) official program config."""

    name: str = "AfDB Japan Africa Dream Scholarship (JADS)"
    url: str = "https://www.afdb.org/en/about-us/careers/japan-africa-dream-scholarship-jads-program"
    source_id: str = "afdb_japan_africa_dream_scholarship_jads"
