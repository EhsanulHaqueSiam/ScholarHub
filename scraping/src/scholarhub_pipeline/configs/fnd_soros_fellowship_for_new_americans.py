"""Soros Fellowship for New Americans source configuration."""
...
class Config(BaseFoundationConfig):
    """Soros Fellowship for New Americans foundation config."""

    name: str = "Soros Fellowship for New Americans"
    url: str = "https://www.pdsoros.org"
    source_id: str = "soros_fellowship_for_new_americans"
