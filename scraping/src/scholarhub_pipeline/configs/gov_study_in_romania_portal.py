"""Study in Romania Portal source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Romania Portal government config."""

    name: str = "Study in Romania Portal"
    url: str = "https://www.study-in-romania.ro/scholarships"
    source_id: str = "study_in_romania_portal"
