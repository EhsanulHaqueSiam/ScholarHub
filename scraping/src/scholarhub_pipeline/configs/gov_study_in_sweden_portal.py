"""Study in Sweden Portal source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Sweden Portal government config."""

    name: str = "Study in Sweden Portal"
    url: str = "https://studyinsweden.se/scholarships/"
    source_id: str = "study_in_sweden_portal"
