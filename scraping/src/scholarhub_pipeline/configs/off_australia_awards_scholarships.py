"""Australia Awards Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Australia Awards Scholarships official program config."""

    name: str = "Australia Awards Scholarships"
    url: str = "https://www.dfat.gov.au/people-to-people/australia-awards"
    source_id: str = "australia_awards_scholarships"
