"""Scholarships for Development source configuration."""
...
class Config(BaseAggregatorConfig):
    """Scholarships for Development aggregator config."""

    name: str = "Scholarships for Development"
    url: str = "https://www.scholarshipsads.com"
    source_id: str = "scholarships_for_development"
