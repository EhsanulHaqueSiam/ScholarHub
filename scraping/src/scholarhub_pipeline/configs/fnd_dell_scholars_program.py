"""Dell Scholars Program source configuration."""
...
class Config(BaseFoundationConfig):
    """Dell Scholars Program foundation config."""

    name: str = "Dell Scholars Program"
    url: str = "https://www.dellscholars.org"
    source_id: str = "dell_scholars_program"
