"""US State Department Exchanges source configuration."""
...
class Config(BaseGovernmentConfig):
    """US State Department Exchanges government config."""

    name: str = "US State Department Exchanges"
    url: str = "https://exchanges.state.gov/non-us/program-type/scholarship"
    source_id: str = "us_state_department_exchanges"
