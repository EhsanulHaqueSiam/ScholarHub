"""Czech Government Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Czech Government Scholarships official program config."""

    name: str = "Czech Government Scholarships"
    url: str = "https://www.studyin.cz/scholarships/"
    source_id: str = "czech_government_scholarships"
