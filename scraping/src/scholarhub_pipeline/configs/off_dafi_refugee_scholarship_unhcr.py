"""DAFI Refugee Scholarship (UNHCR) source configuration."""
...
class Config(BaseOfficialConfig):
    """DAFI Refugee Scholarship (UNHCR) official program config."""

    name: str = "DAFI Refugee Scholarship (UNHCR)"
    url: str = "https://www.unhcr.org/what-we-do/build-better-futures/education/tertiary-education"
    source_id: str = "dafi_refugee_scholarship_unhcr"
