"""Marshall Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """Marshall Scholarship official program config."""

    name: str = "Marshall Scholarship"
    url: str = "https://www.marshallscholarship.org"
    source_id: str = "marshall_scholarship"
