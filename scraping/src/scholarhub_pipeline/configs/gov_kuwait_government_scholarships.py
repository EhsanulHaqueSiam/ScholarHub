"""Kuwait Government Scholarships source configuration."""
...
class Config(BaseGovernmentConfig):
    """Kuwait Government Scholarships government config."""

    name: str = "Kuwait Government Scholarships"
    url: str = "https://www.mohe.edu.kw/en/"
    source_id: str = "kuwait_government_scholarships"
