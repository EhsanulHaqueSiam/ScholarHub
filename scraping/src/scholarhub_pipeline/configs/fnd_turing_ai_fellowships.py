"""Turing AI Fellowships source configuration."""
...
class Config(BaseFoundationConfig):
    """Turing AI Fellowships foundation config."""

    name: str = "Turing AI Fellowships"
    url: str = "https://www.turing.ac.uk/work-turing/studentships"
    source_id: str = "turing_ai_fellowships"
