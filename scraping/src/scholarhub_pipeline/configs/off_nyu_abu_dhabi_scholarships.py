"""NYU Abu Dhabi Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """NYU Abu Dhabi Scholarships official program config."""

    name: str = "NYU Abu Dhabi Scholarships"
    url: str = "https://nyuad.nyu.edu/en/admissions/financial-aid.html"
    source_id: str = "nyu_abu_dhabi_scholarships"
