"""Opportunity Desk source configuration."""
...
class Config(BaseAggregatorConfig):
    """Opportunity Desk aggregator config."""

    name: str = "Opportunity Desk"
    url: str = "https://opportunitydesk.org"
    source_id: str = "opportunity_desk"
