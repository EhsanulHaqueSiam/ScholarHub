"""Qatar Foundation Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Qatar Foundation Scholarships official program config."""

    name: str = "Qatar Foundation Scholarships"
    url: str = "https://www.qf.org.qa/education/scholarships"
    source_id: str = "qatar_foundation_scholarships"
