"""Konrad Adenauer Foundation Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Konrad Adenauer Foundation Scholarships official program config."""

    name: str = "Konrad Adenauer Foundation Scholarships"
    url: str = "https://www.kas.de/en/scholarships"
    source_id: str = "konrad_adenauer_foundation_scholarships"
