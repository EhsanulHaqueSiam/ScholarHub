"""Study in Russia Portal source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Russia Portal government config."""

    name: str = "Study in Russia Portal"
    url: str = "https://studyinrussia.ru/en/study-in-russia/scholarships/"
    source_id: str = "study_in_russia_portal"
