"""Niche Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """Niche Scholarships aggregator config."""

    name: str = "Niche Scholarships"
    url: str = "https://www.niche.com/colleges/scholarships"
    source_id: str = "niche_scholarships"
