"""Chevron Corporation Scholarships source configuration."""
...
class Config(BaseFoundationConfig):
    """Chevron Corporation Scholarships foundation config."""

    name: str = "Chevron Corporation Scholarships"
    url: str = "https://www.chevron.com/sustainability/social/education"
    source_id: str = "chevron_corporation_scholarships"
