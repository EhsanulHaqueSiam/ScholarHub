"""Kenyan Government Scholarships (KUCCPS) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Kenyan Government Scholarships (KUCCPS) government config."""

    name: str = "Kenyan Government Scholarships (KUCCPS)"
    url: str = "https://www.kuccps.net"
    source_id: str = "kenyan_government_scholarships_kuccps"
