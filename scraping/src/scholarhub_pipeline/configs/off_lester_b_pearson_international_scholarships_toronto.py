"""Lester B. Pearson International Scholarships (Toronto) source configuration."""
...
class Config(BaseOfficialConfig):
    """Lester B. Pearson International Scholarships (Toronto) official program config."""

    name: str = "Lester B. Pearson International Scholarships (Toronto)"
    url: str = "https://future.utoronto.ca/pearson/"
    source_id: str = "lester_b_pearson_international_scholarships_toronto"
