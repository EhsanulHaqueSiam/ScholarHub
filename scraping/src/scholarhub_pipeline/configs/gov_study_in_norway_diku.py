"""Study in Norway (Diku) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Norway (Diku) government config."""

    name: str = "Study in Norway (Diku)"
    url: str = "https://www.studyinnorway.no/scholarships"
    source_id: str = "study_in_norway_diku"
