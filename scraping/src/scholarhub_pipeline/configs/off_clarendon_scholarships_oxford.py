"""Clarendon Scholarships (Oxford) source configuration."""
...
class Config(BaseOfficialConfig):
    """Clarendon Scholarships (Oxford) official program config."""

    name: str = "Clarendon Scholarships (Oxford)"
    url: str = "https://www.ox.ac.uk/clarendon/"
    source_id: str = "clarendon_scholarships_oxford"
