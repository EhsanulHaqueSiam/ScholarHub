"""Study in Italy (Uni-Italia) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Italy (Uni-Italia) government config."""

    name: str = "Study in Italy (Uni-Italia)"
    url: str = "https://www.uni-italia.it/en/scholarships"
    source_id: str = "study_in_italy_uniitalia"
