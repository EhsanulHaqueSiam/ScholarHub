"""Nigerian Government Scholarships (PTDF) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Nigerian Government Scholarships (PTDF) government config."""

    name: str = "Nigerian Government Scholarships (PTDF)"
    url: str = "https://ptdf.gov.ng/scholarship/"
    source_id: str = "nigerian_government_scholarships_ptdf"
