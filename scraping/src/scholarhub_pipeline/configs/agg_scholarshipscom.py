"""Scholarships.com source configuration."""
...
class Config(BaseAggregatorConfig):
    """Scholarships.com aggregator config."""

    name: str = "Scholarships.com"
    url: str = "https://www.scholarships.com"
    source_id: str = "scholarshipscom"
