"""Canada Vanier Graduate Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Canada Vanier Graduate Scholarships official program config."""

    name: str = "Canada Vanier Graduate Scholarships"
    url: str = "https://vanier.gc.ca/en/home-accueil.html"
    source_id: str = "canada_vanier_graduate_scholarships"
