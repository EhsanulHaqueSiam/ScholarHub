"""Canada Banting Postdoctoral Fellowships source configuration."""
...
class Config(BaseOfficialConfig):
    """Canada Banting Postdoctoral Fellowships official program config."""

    name: str = "Canada Banting Postdoctoral Fellowships"
    url: str = "https://banting.fellowships-bourses.gc.ca/en/home-accueil.html"
    source_id: str = "canada_banting_postdoctoral_fellowships"
