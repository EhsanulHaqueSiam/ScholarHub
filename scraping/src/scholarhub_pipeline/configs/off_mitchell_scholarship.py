"""Mitchell Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """Mitchell Scholarship official program config."""

    name: str = "Mitchell Scholarship"
    url: str = "https://www.us-irelandalliance.org/mitchellscholarship"
    source_id: str = "mitchell_scholarship"
