"""Study in Taiwan (MOE) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Taiwan (MOE) government config."""

    name: str = "Study in Taiwan (MOE)"
    url: str = "https://www.studyintaiwan.org/scholarship"
    source_id: str = "study_in_taiwan_moe"
