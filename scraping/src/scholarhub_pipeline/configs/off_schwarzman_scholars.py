"""Schwarzman Scholars source configuration."""
...
class Config(BaseOfficialConfig):
    """Schwarzman Scholars official program config."""

    name: str = "Schwarzman Scholars"
    url: str = "https://www.schwarzmanscholars.org"
    source_id: str = "schwarzman_scholars"
