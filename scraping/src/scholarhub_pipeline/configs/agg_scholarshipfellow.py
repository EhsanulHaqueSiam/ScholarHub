"""ScholarshipFellow source configuration."""
...
class Config(BaseAggregatorConfig):
    """ScholarshipFellow aggregator config."""

    name: str = "ScholarshipFellow"
    url: str = "https://scholarshipfellow.com"
    source_id: str = "scholarshipfellow"
