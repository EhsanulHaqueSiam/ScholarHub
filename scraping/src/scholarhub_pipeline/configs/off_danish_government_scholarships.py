"""Danish Government Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Danish Government Scholarships official program config."""

    name: str = "Danish Government Scholarships"
    url: str = "https://studyindenmark.dk/scholarships"
    source_id: str = "danish_government_scholarships"
