"""BridgeU Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """BridgeU Scholarships aggregator config."""

    name: str = "BridgeU Scholarships"
    url: str = "https://bridge-u.com/scholarship-search"
    source_id: str = "bridgeu_scholarships"
