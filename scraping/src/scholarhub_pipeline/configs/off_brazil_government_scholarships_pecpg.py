"""Brazil Government Scholarships (PEC-PG) source configuration."""
...
class Config(BaseOfficialConfig):
    """Brazil Government Scholarships (PEC-PG) official program config."""

    name: str = "Brazil Government Scholarships (PEC-PG)"
    url: str = "https://www.gov.br/capes/pt-br/acesso-a-informacao/acoes-e-programas/bolsas/bolsas-e-auxilios-internacionais/pec-pg"
    source_id: str = "brazil_government_scholarships_pecpg"
