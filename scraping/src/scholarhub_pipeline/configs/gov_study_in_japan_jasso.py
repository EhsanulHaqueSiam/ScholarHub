"""Study in Japan (JASSO) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Japan (JASSO) government config."""

    name: str = "Study in Japan (JASSO)"
    url: str = "https://www.jasso.go.jp/en/ryugaku/scholarship_j/index.html"
    source_id: str = "study_in_japan_jasso"
