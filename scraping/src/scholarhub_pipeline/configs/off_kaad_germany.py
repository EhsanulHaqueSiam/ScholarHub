"""KAAD Germany source configuration."""
...
class Config(BaseOfficialConfig):
    """KAAD Germany official program config."""

    name: str = "KAAD Germany"
    url: str = "https://www.kaad.de/en/scholarships/"
    source_id: str = "kaad_germany"
