"""GIZ Scholarship Programmes source configuration."""
...
class Config(BaseGovernmentConfig):
    """GIZ Scholarship Programmes government config."""

    name: str = "GIZ Scholarship Programmes"
    url: str = "https://www.giz.de/en/worldwide/18975.html"
    source_id: str = "giz_scholarship_programmes"
