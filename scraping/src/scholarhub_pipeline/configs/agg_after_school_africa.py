"""After School Africa source configuration."""
...
class Config(BaseAggregatorConfig):
    """After School Africa aggregator config."""

    name: str = "After School Africa"
    url: str = "https://www.afterschoolafrica.com"
    source_id: str = "after_school_africa"
