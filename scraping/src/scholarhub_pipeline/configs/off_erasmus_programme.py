"""Erasmus+ Programme source configuration."""
...
class Config(BaseOfficialConfig):
    """Erasmus+ Programme official program config."""

    name: str = "Erasmus+ Programme"
    url: str = "https://erasmus-plus.ec.europa.eu"
    source_id: str = "erasmus_programme"
    ...
    pagination: dict | None = field(default_factory=lambda: {'type': 'url', 'selector': '.pagination .next::attr(href), a.next::attr(href)', 'max_pages': 15})
