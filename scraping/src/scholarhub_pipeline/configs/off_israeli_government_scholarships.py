"""Israeli Government Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Israeli Government Scholarships official program config."""

    name: str = "Israeli Government Scholarships"
    url: str = "https://mfa.gov.il/mfa/mashav/scholarships"
    source_id: str = "israeli_government_scholarships"
