"""Study in Korea (NIIED) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Korea (NIIED) government config."""

    name: str = "Study in Korea (NIIED)"
    url: str = "https://www.studyinkorea.go.kr/en/sub/gks/allnew_scholarship.do"
    source_id: str = "study_in_korea_niied"
