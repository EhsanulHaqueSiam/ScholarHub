"""Uganda Government Scholarships source configuration."""
...
class Config(BaseGovernmentConfig):
    """Uganda Government Scholarships government config."""

    name: str = "Uganda Government Scholarships"
    url: str = "https://www.education.go.ug/scholarships/"
    source_id: str = "uganda_government_scholarships"
