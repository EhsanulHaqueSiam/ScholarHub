"""Friedrich Ebert Foundation Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Friedrich Ebert Foundation Scholarships official program config."""

    name: str = "Friedrich Ebert Foundation Scholarships"
    url: str = "https://www.fes.de/en/scholarships"
    source_id: str = "friedrich_ebert_foundation_scholarships"
