"""Austrian OeAD Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Austrian OeAD Scholarships official program config."""

    name: str = "Austrian OeAD Scholarships"
    url: str = "https://oead.at/en/to-austria/scholarships"
    source_id: str = "austrian_oead_scholarships"
