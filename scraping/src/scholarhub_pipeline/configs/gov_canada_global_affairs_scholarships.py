"""Canada Global Affairs Scholarships source configuration."""
...
class Config(BaseGovernmentConfig):
    """Canada Global Affairs Scholarships government config."""

    name: str = "Canada Global Affairs Scholarships"
    url: str = "https://www.educanada.ca/scholarships-bourses/index.aspx"
    source_id: str = "canada_global_affairs_scholarships"
