"""MastersPortal Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """MastersPortal Scholarships aggregator config."""

    name: str = "MastersPortal Scholarships"
    url: str = "https://www.mastersportal.com/scholarships"
    source_id: str = "mastersportal_scholarships"
