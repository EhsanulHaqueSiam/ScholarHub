"""King Abdullah University Scholarships (KAUST) source configuration."""
...
class Config(BaseOfficialConfig):
    """King Abdullah University Scholarships (KAUST) official program config."""

    name: str = "King Abdullah University Scholarships (KAUST)"
    url: str = "https://www.kaust.edu.sa/en/study/scholarships"
    source_id: str = "king_abdullah_university_scholarships_kaust"
