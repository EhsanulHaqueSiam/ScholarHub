"""Emile Boutmy Scholarship (Sciences Po) source configuration."""
...
class Config(BaseOfficialConfig):
    """Emile Boutmy Scholarship (Sciences Po) official program config."""

    name: str = "Emile Boutmy Scholarship (Sciences Po)"
    url: str = "https://www.sciencespo.fr/en/admissions/emile-boutmy-scholarship"
    source_id: str = "emile_boutmy_scholarship_sciences_po"
