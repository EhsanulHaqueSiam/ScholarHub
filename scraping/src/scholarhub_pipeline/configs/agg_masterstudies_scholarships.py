"""MasterStudies Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """MasterStudies Scholarships aggregator config."""

    name: str = "MasterStudies Scholarships"
    url: str = "https://www.masterstudies.com/scholarships"
    source_id: str = "masterstudies_scholarships"
    ...
    pagination: dict | None = field(default_factory=lambda: {'type': 'url', 'selector': '.pagination .next::attr(href), a.next::attr(href)', 'max_pages': 60})
