"""PhDPortal Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """PhDPortal Scholarships aggregator config."""

    name: str = "PhDPortal Scholarships"
    url: str = "https://www.phdportal.com/scholarships"
    source_id: str = "phdportal_scholarships"
