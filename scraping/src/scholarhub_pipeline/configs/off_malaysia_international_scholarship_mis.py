"""Malaysia International Scholarship (MIS) source configuration."""
...
class Config(BaseOfficialConfig):
    """Malaysia International Scholarship (MIS) official program config."""

    name: str = "Malaysia International Scholarship (MIS)"
    url: str = "https://biasiswa.mohe.gov.my/INTER/index.php"
    source_id: str = "malaysia_international_scholarship_mis"
