"""Microsoft Scholarship Program source configuration."""
...
class Config(BaseFoundationConfig):
    """Microsoft Scholarship Program foundation config."""

    name: str = "Microsoft Scholarship Program"
    url: str = "https://www.microsoft.com/en-us/diversity/programs/scholarships"
    source_id: str = "microsoft_scholarship_program"
