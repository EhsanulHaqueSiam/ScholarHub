"""Peru Government Scholarships (PRONABEC) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Peru Government Scholarships (PRONABEC) government config."""

    name: str = "Peru Government Scholarships (PRONABEC)"
    url: str = "https://www.pronabec.gob.pe"
    source_id: str = "peru_government_scholarships_pronabec"
