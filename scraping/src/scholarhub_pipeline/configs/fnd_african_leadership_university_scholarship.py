"""African Leadership University Scholarship source configuration."""
...
class Config(BaseFoundationConfig):
    """African Leadership University Scholarship foundation config."""

    name: str = "African Leadership University Scholarship"
    url: str = "https://www.alueducation.com/financial-aid/"
    source_id: str = "african_leadership_university_scholarship"
