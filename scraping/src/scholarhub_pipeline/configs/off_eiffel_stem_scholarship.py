"""Eiffel STEM Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """Eiffel STEM Scholarship official program config."""

    name: str = "Eiffel STEM Scholarship"
    url: str = "https://www.campusfrance.org/en/eiffel-program"
    source_id: str = "eiffel_stem_scholarship"
