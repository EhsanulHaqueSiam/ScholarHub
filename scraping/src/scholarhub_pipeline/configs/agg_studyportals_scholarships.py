"""StudyPortals Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """StudyPortals Scholarships aggregator config."""

    name: str = "StudyPortals Scholarships"
    url: str = "https://www.scholarshipportal.com/scholarships"
    source_id: str = "studyportals_scholarships"
