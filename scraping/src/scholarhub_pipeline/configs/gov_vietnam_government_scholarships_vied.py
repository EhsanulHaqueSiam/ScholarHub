"""Vietnam Government Scholarships (VIED) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Vietnam Government Scholarships (VIED) government config."""

    name: str = "Vietnam Government Scholarships (VIED)"
    url: str = "https://vied.vn/en/"
    source_id: str = "vietnam_government_scholarships_vied"
