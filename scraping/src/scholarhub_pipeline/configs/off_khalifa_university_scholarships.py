"""Khalifa University Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Khalifa University Scholarships official program config."""

    name: str = "Khalifa University Scholarships"
    url: str = "https://www.ku.ac.ae/admissions/scholarships"
    source_id: str = "khalifa_university_scholarships"
