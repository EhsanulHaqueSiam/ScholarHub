"""ScholarshipOwl source configuration."""
...
class Config(BaseAggregatorConfig):
    """ScholarshipOwl aggregator config."""

    name: str = "ScholarshipOwl"
    url: str = "https://scholarshipowl.com"
    source_id: str = "scholarshipowl"
