"""Mo Ibrahim Foundation Scholarships source configuration."""
...
class Config(BaseFoundationConfig):
    """Mo Ibrahim Foundation Scholarships foundation config."""

    name: str = "Mo Ibrahim Foundation Scholarships"
    url: str = "https://mo.ibrahim.foundation/fellowships"
    source_id: str = "mo_ibrahim_foundation_scholarships"
