"""Mandela Rhodes Foundation Scholarships source configuration."""
...
class Config(BaseFoundationConfig):
    """Mandela Rhodes Foundation Scholarships foundation config."""

    name: str = "Mandela Rhodes Foundation Scholarships"
    url: str = "https://mandelarhodes.org"
    source_id: str = "mandela_rhodes_foundation_scholarships"
