"""ScholarshipsIn source configuration."""
...
class Config(BaseAggregatorConfig):
    """ScholarshipsIn aggregator config."""

    name: str = "ScholarshipsIn"
    url: str = "https://www.scholarshipsin.com"
    source_id: str = "scholarshipsin"
