"""Philippines Government Scholarships (CHED) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Philippines Government Scholarships (CHED) government config."""

    name: str = "Philippines Government Scholarships (CHED)"
    url: str = "https://ched.gov.ph/scholarships/"
    source_id: str = "philippines_government_scholarships_ched"
