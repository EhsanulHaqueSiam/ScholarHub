"""Ethiopian Government Scholarships source configuration."""
...
class Config(BaseGovernmentConfig):
    """Ethiopian Government Scholarships government config."""

    name: str = "Ethiopian Government Scholarships"
    url: str = "https://www.moe.gov.et"
    source_id: str = "ethiopian_government_scholarships"
