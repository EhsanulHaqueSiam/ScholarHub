"""Saudi Arabian Cultural Mission (SACM) Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """Saudi Arabian Cultural Mission (SACM) Scholarship official program config."""

    name: str = "Saudi Arabian Cultural Mission (SACM) Scholarship"
    url: str = "https://www.moe.gov.sa/en/education/highereducation/Pages/Scholarships.aspx"
    source_id: str = "saudi_arabian_cultural_mission_sacm_scholarship"
