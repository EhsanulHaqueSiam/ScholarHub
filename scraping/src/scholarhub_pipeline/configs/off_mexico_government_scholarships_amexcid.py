"""Mexico Government Scholarships (AMEXCID) source configuration."""
...
class Config(BaseOfficialConfig):
    """Mexico Government Scholarships (AMEXCID) official program config."""

    name: str = "Mexico Government Scholarships (AMEXCID)"
    url: str = "https://www.gob.mx/amexcid/acciones-y-programas/becas-para-extranjeros"
    source_id: str = "mexico_government_scholarships_amexcid"
