"""Rwanda Government Scholarships source configuration."""
...
class Config(BaseGovernmentConfig):
    """Rwanda Government Scholarships government config."""

    name: str = "Rwanda Government Scholarships"
    url: str = "https://www.mineduc.gov.rw/scholarships"
    source_id: str = "rwanda_government_scholarships"
