"""Said Foundation Scholarships source configuration."""
...
class Config(BaseFoundationConfig):
    """Said Foundation Scholarships foundation config."""

    name: str = "Said Foundation Scholarships"
    url: str = "https://www.saidfoundation.org/scholarships"
    source_id: str = "said_foundation_scholarships"
