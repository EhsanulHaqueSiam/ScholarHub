"""DiscoverPhDs Funding source configuration."""
...
class Config(BaseAggregatorConfig):
    """DiscoverPhDs Funding aggregator config."""

    name: str = "DiscoverPhDs Funding"
    url: str = "https://www.discoverphds.com/funding"
    source_id: str = "discoverphds_funding"
