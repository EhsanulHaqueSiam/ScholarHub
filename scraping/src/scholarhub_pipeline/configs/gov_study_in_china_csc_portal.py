"""Study in China (CSC Portal) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in China (CSC Portal) government config."""

    name: str = "Study in China (CSC Portal)"
    url: str = "https://www.csc.edu.cn/laihua"
    source_id: str = "study_in_china_csc_portal"
