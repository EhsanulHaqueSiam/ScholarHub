"""Singapore Government Scholarships (MOE) source configuration."""
...
class Config(BaseOfficialConfig):
    """Singapore Government Scholarships (MOE) official program config."""

    name: str = "Singapore Government Scholarships (MOE)"
    url: str = "https://www.moe.gov.sg/financial-matters/awards-scholarships"
    source_id: str = "singapore_government_scholarships_moe"
