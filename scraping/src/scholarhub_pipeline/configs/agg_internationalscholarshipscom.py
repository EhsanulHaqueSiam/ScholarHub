...
class Config(BaseAggregatorConfig):
    """InternationalScholarships.com aggregator config."""

    name: str = "InternationalScholarships.com"
    url: str = "https://www.internationalscholarships.com"
    source_id: str = "internationalscholarshipscom"
