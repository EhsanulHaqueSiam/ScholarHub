"""Study in Germany Portal source configuration."""
...
class Config(BaseGovernmentConfig):
    """Study in Germany Portal government config."""

    name: str = "Study in Germany Portal"
    url: str = "https://www.study-in-germany.de/en/plan-your-studies/financing-your-studies/scholarships/"
    source_id: str = "study_in_germany_portal"
