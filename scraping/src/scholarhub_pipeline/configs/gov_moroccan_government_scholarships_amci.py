"""Moroccan Government Scholarships (AMCI) source configuration."""
...
class Config(BaseGovernmentConfig):
    """Moroccan Government Scholarships (AMCI) government config."""

    name: str = "Moroccan Government Scholarships (AMCI)"
    url: str = "https://www.amci.ma/en/bourses"
    source_id: str = "moroccan_government_scholarships_amci"
