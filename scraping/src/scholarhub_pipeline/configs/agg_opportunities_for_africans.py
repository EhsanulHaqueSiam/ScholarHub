"""Opportunities For Africans source configuration."""
...
class Config(BaseAggregatorConfig):
    """Opportunities For Africans aggregator config."""

    name: str = "Opportunities For Africans"
    url: str = "https://www.opportunitiesforafricans.com"
    source_id: str = "opportunities_for_africans"
