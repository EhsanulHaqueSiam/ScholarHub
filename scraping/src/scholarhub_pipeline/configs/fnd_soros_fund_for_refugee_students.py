"""Soros Fund for Refugee Students source configuration."""
...
class Config(BaseFoundationConfig):
    """Soros Fund for Refugee Students foundation config."""

    name: str = "Soros Fund for Refugee Students"
    url: str = "https://www.opensocietyfoundations.org/grants/civil-society-scholar-awards"
    source_id: str = "soros_fund_for_refugee_students"
