"""GoAbroad Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """GoAbroad Scholarships aggregator config."""

    name: str = "GoAbroad Scholarships"
    url: str = "https://www.goabroad.com/scholarships-abroad"
    source_id: str = "goabroad_scholarships"
    ...
    pagination: dict | None = field(default_factory=lambda: {'type': 'url', 'selector': '.pagination .next::attr(href), a.next::attr(href)', 'max_pages': 25})
