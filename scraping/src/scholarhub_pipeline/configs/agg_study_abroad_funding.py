"""Study Abroad Funding source configuration."""
...
class Config(BaseAggregatorConfig):
    """Study Abroad Funding aggregator config."""

    name: str = "Study Abroad Funding"
    url: str = "https://www.studyabroadfunding.org"
    source_id: str = "study_abroad_funding"
    ...
    pagination: dict | None = field(default_factory=lambda: {'type': 'url', 'selector': '.pagination .next::attr(href), a.next::attr(href)', 'max_pages': 40})
