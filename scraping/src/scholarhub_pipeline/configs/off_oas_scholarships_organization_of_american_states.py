"""OAS Scholarships (Organization of American States) source configuration."""
...
class Config(BaseOfficialConfig):
    """OAS Scholarships (Organization of American States) official program config."""

    name: str = "OAS Scholarships (Organization of American States)"
    url: str = "https://www.oas.org/en/scholarships/"
    source_id: str = "oas_scholarships_organization_of_american_states"
