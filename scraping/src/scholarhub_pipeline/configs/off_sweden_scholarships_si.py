"""Sweden Scholarships (SI) source configuration."""
...
class Config(BaseOfficialConfig):
    """Sweden Scholarships (SI) official program config."""

    name: str = "Sweden Scholarships (SI)"
    url: str = "https://si.se/en/apply/scholarships/swedish-institute-scholarships-for-global-professionals/"
    source_id: str = "sweden_scholarships_si"
