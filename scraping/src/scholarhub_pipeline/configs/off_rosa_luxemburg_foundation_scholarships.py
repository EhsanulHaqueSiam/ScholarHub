"""Rosa Luxemburg Foundation Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Rosa Luxemburg Foundation Scholarships official program config."""

    name: str = "Rosa Luxemburg Foundation Scholarships"
    url: str = "https://www.rosalux.de/en/foundation/studienwerk"
    source_id: str = "rosa_luxemburg_foundation_scholarships"
