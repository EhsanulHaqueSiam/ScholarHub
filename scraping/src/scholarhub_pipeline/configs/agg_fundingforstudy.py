"""FundingForStudy source configuration."""
...
class Config(BaseAggregatorConfig):
    """FundingForStudy aggregator config."""

    name: str = "FundingForStudy"
    # Original domain is no longer reliably resolvable; use active funding mirror.
    url: str = "https://www.studyabroadfunding.org/"
    source_id: str = "fundingforstudy"
    ...
    pagination: dict | None = field(default_factory=lambda: {'type': 'url', 'selector': '.pagination .next::attr(href), a.next::attr(href)', 'max_pages': 30})
