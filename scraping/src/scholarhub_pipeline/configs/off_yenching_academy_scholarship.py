"""Yenching Academy Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """Yenching Academy Scholarship official program config."""

    name: str = "Yenching Academy Scholarship"
    url: str = "https://yenchingacademy.pku.edu.cn"
    source_id: str = "yenching_academy_scholarship"
