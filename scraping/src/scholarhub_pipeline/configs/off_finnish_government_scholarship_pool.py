"""Finnish Government Scholarship Pool source configuration."""
...
class Config(BaseOfficialConfig):
    """Finnish Government Scholarship Pool official program config."""

    name: str = "Finnish Government Scholarship Pool"
    url: str = "https://www.studyinfinland.fi/scholarships"
    source_id: str = "finnish_government_scholarship_pool"
