"""Romanian Government Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Romanian Government Scholarships official program config."""

    name: str = "Romanian Government Scholarships"
    url: str = "https://www.edu.ro/scholarships"
    source_id: str = "romanian_government_scholarships"
