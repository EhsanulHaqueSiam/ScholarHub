"""StudyInEurope Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """StudyInEurope Scholarships aggregator config."""

    name: str = "StudyInEurope Scholarships"
    url: str = "https://www.studyineurope.eu/scholarships"
    source_id: str = "studyineurope_scholarships"
    ...
    pagination: dict | None = field(default_factory=lambda: {'type': 'url', 'selector': '.pagination .next::attr(href), a.next::attr(href)', 'max_pages': 20})
