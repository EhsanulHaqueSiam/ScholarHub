"""IsDB Scholarships (Islamic Development Bank) source configuration."""
...
class Config(BaseOfficialConfig):
    """IsDB Scholarships (Islamic Development Bank) official program config."""

    name: str = "IsDB Scholarships (Islamic Development Bank)"
    url: str = "https://www.isdb.org/scholarships"
    source_id: str = "isdb_scholarships_islamic_development_bank"
