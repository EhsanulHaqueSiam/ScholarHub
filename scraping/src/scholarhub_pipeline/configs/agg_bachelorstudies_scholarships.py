"""BachelorStudies Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """BachelorStudies Scholarships aggregator config."""

    name: str = "BachelorStudies Scholarships"
    url: str = "https://www.bachelorstudies.com/scholarships"
    source_id: str = "bachelorstudies_scholarships"
