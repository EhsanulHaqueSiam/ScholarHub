"""Skoll Foundation Scholarships source configuration."""
...
class Config(BaseFoundationConfig):
    """Skoll Foundation Scholarships foundation config."""

    name: str = "Skoll Foundation Scholarships"
    url: str = "https://skoll.org/about/skoll-scholarship/"
    source_id: str = "skoll_foundation_scholarships"
