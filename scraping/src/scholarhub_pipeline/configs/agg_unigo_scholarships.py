"""Unigo Scholarships source configuration."""
...
class Config(BaseAggregatorConfig):
    """Unigo Scholarships aggregator config."""

    name: str = "Unigo Scholarships"
    url: str = "https://www.unigo.com/scholarships"
    source_id: str = "unigo_scholarships"
