"""Holland Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """Holland Scholarship official program config."""

    name: str = "Holland Scholarship"
    url: str = "https://www.studyinholland.nl/finances/scholarships/holland-scholarship"
    source_id: str = "holland_scholarship"
