"""Greek Government Scholarships (IKY) source configuration."""
...
class Config(BaseOfficialConfig):
    """Greek Government Scholarships (IKY) official program config."""

    name: str = "Greek Government Scholarships (IKY)"
    url: str = "https://www.iky.gr/en/"
    source_id: str = "greek_government_scholarships_iky"
