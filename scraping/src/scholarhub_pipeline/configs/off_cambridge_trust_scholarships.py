"""Cambridge Trust Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Cambridge Trust Scholarships official program config."""

    name: str = "Cambridge Trust Scholarships"
    url: str = "https://www.cambridgetrust.org"
    source_id: str = "cambridge_trust_scholarships"
