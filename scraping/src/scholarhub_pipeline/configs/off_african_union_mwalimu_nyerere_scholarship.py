"""African Union Mwalimu Nyerere Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """African Union Mwalimu Nyerere Scholarship official program config."""

    name: str = "African Union Mwalimu Nyerere Scholarship"
    url: str = "https://au.int/en/education/mwalimu-nyerere-african-union-scholarship"
    source_id: str = "african_union_mwalimu_nyerere_scholarship"
