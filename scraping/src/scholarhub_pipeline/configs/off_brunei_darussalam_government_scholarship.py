"""Brunei Darussalam Government Scholarship source configuration."""
...
class Config(BaseOfficialConfig):
    """Brunei Darussalam Government Scholarship official program config."""

    name: str = "Brunei Darussalam Government Scholarship"
    url: str = "https://www.moe.gov.bn/Pages/BDGS.aspx"
    source_id: str = "brunei_darussalam_government_scholarship"
