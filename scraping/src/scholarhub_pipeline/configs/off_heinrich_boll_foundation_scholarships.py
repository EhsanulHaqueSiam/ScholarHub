"""Heinrich Boll Foundation Scholarships source configuration."""
...
class Config(BaseOfficialConfig):
    """Heinrich Boll Foundation Scholarships official program config."""

    name: str = "Heinrich Boll Foundation Scholarships"
    url: str = "https://www.boell.de/en/scholarships"
    source_id: str = "heinrich_boll_foundation_scholarships"
